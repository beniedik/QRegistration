                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <ul class="list-group list-group-flush">
                                    ...
                                    <li class="list-group-item">Front:<br/><img src="<?php echo $itemimgfront;?>" width="300" alt="Item Front"/> <?php echo $itemSN; ?></li>
                                    <li class="list-group-item">Back:<br/><img src="<?php echo $itemimgfront;?>" width="300" alt="Item Front"/> <?php echo $itemSN; ?></li>
                                    <li class="list-group-item">Serial #:<br/><img src="<?php echo $itemimgfront;?>" width="300" alt="Item Front"/> <?php echo $itemSN; ?></li>
                                </ul>
                                <br />
